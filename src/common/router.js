...
const router = new VueRouter({
  ...
  routes: [{
      ...
      children: [
        ...
        {path: '/Demo',name: 'Demo',meta: {title: 'Demo333',keepAlive: true},component: (resolve) => require(['@/pages/Demo/index.vue'], resolve),},
        {path: '/itemdevice',name: 'Demo',meta: {title: '菱形测试',keepAlive: true},component: (resolve) => require(['@/pages/itemdevice/index.vue'], resolve),},
